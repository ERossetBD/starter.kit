"""Nom : main.py
   ...
   Description : Script main qui récupère le fichier des logements,
   mets à jour les prix et génère un nouvel export."""
...
def createListLogement(dataframe):
    ...
    """
    lst = [
        Logement(a.ID, a.Adresse, a.Ville, a.Categorie, a.Surface, a.Prix)
        for a in dataframe.itertuples()
    ]
    return lst
